...
#RUN apt-get install -y libc6-i386 lib32stdc++6 lib32gcc1 lib32ncurses5 libstdc++6:i386 libgcc1:i386 zlib1g:i386 libncurses5:i386
...
RUN echo y | android update sdk -u --all --filter 6,7,29,137,138,144,145 --force
